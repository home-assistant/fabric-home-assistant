    ...
    with cd("/srv/homeassistant/src"):
        ...
        with cd("open-zwave-control-panel"):
            ...
            if pi_hardware == "armv7l":
                sudo("ln -sd /srv/homeassistant/homeassistant_venv/lib/python3.4/site-packages/libopenzwave-0.3.1-py3.4-linux-armv7l.egg/config")
            else:
                sudo("ln -sd /srv/homeassistant/homeassistant_venv/lib/python3.4/site-packages/libopenzwave-0.3.1-py3.4-linux-armv**6**l.egg/config")
